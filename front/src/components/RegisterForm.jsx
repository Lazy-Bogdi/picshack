...
function RegisterForm({ onRegistrationSuccess }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="form-control">
            ...
            <input type="text" placeholder="Nom complet" className="input input-bordered" value={name} onChange={(e) => setName(e.target.value)} required />
            ...
            <button type="submit" className="btn btn-primary mt-4" disabled={!passwordsMatch}>
                Inscription
            </button>   
        </form>
    );
